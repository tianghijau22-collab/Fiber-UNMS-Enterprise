      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-lg border border-slate-200 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in duration-150">
        ...
        {isPasswordRedirecting ? (
          <div className="p-8 text-center space-y-4 animate-in zoom-in-95 duration-200">
            <div className="w-16 h-16 rounded-2xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-400 font-bold text-3xl flex items-center justify-center mx-auto shadow-lg shadow-emerald-950/50 animate-bounce">
              🔑
            </div>
          ...
          {showUserMenu && (
            <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-black border border-slate-200 dark:border-[#222222] rounded-lg shadow-xl py-2 z-30 animate-in fade-in slide-in-from-top-2 duration-150">
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-neutral-900 flex items-center gap-2"
              >
                ⚙️ Edit Profil Saya
              </button>
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-neutral-900 flex items-center gap-2"
              >
                🛡️ {isSuperAdmin ? 'Audit Logs System' : 'Audit Logs Aktivitas Saya'}
              </button>
              ...
              <button
                ...
                className="w-full text-left px-4 py-2 text-xs font-semibold text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-neutral-900 flex items-center gap-2"
              >
                🚪 Keluar (Logout)
              </button>
            </div>
