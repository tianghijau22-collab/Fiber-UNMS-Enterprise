...
# Truncate at line 2873 (`);`)
clean_lines = lines[:2873]

# Now insert `{selectedOdp && (...) }` right before `</div>` at line 2872 (index 2871)
odp_modal_jsx = '''      {/* Modal Detail Port & Monitoring Sinyal ODP */}
      {selectedOdp && (
