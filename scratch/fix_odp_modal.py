...
filepath = 'resources/js/pages/NetworkInfrastructure.jsx'

with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace from `selectedOdp && (` to `/* Modal Footer */`
old_pattern = r'\{selectedOdp && \([\s\S]*?\{\/\* Modal Footer \*\/\}\s*<div className="p-4 bg-slate-50'

new_block = '''{selectedOdp && (
